...
function PoleColumn({
  ...
  return (
    <div className="relative h-full flex items-end justify-center">
      <div className="absolute max-sm:bottom-[10.5%] bottom-[10.1%] left-1/2 -translate-x-1/2 h-[88%] w-1.5 rounded-t-full rounded-b-none bg-gradient-to-b from-white/10 to-white/25 opacity-60 mix-blend-soft-light z-0" />
      ...
      <div
        ...
        style={{
          rowGap: `${gapPx}px`,
          paddingBottom: `${gapPx + 29 - compactness}px`,
        }}
      >
